          ...
          {tech.map((t, i) => (
            ...
            >
              ...
              <motion.div
                ...
                className="group"
              >
                <div className="surface-card grid size-[76px] place-items-center transition-all duration-500 group-hover:border-brand group-hover:shadow-[0_20px_44px_-20px_var(--brand)]">
                  <span className="text-sm font-extrabold text-muted-foreground transition-colors duration-400 group-hover:text-brand">
                    {t.short}
                  </span>
                </div>
